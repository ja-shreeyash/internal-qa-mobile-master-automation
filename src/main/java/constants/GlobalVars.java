...
/**
 * FrameworkConstants stores all the framework related constants. <br/>
 * Class is to avoid extend. <br/>
 * <br/>
 * Jun 8, 2022
 *
 * @version 1.0
...
public class GlobalVars {
  ...
  @Getter final String userHome = System.getProperty("user.home");
  ...
  @Getter final String appPath = userDir.concat("/app");
  @Getter final String reportDir = userDir.concat("/allure-results");
  ...
  @Getter final String remote = "remote";
  @Getter final String existingAppium = "existingappium";
  @Getter final String android = "ANDROID";
  @Getter final String ios = "IOS";
  @Getter HashMap<String, Boolean> connectedDevices = new HashMap<>();
  @Getter final String logSeparator =
      "***********************************************************************************************************";
